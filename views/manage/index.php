...
<html lang="en">
	...
	<body ng-app="churchis">
		...
		<div id="footer">
			<p class="footer-sm"><a href="http://frontlinegr.com">Frontline Community Church</a> Small Groups<br>Need help? <a href="mailto:<?=htmlentities($_SERVER['OFFICE_EMAIL']); ?>"><?=htmlentities($_SERVER['OFFICE_EMAIL']); ?></a></p>
